...
export function renderMap(container) {
  // Lock main container so map doesn't scroll — restore when leaving
  container.innerHTML = `
      ...
      <div style="background:white;border-bottom:1px solid #E3F2FD;padding:10px 16px;display:flex;align-items:center;gap:10px;flex-shrink:0;z-index:10">
        ...
        <div style="display:flex;align-items:center;gap:8px;flex:1;min-width:0">
          ...
          <div style="position:relative;flex:1;min-width:0;max-width:220px">
            <input id="map-search"
              style="width:100%;padding:8px 12px 8px 34px;border:1.5px solid #E3F2FD;border-radius:22px;font-size:16px;color:#0A2540;outline:none;font-family:'Inter',sans-serif;transition:border-color .2s;background:#F7FBFF"
