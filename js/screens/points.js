...
export function renderPoints(container) {
  ...
  container.innerHTML = `
    <div style="display:flex;flex-direction:column;height:100%;overflow:hidden;background:#F0F8FF">
      ...
      <div style="background:linear-gradient(160deg,#0A2540 0%,#1255A0 100%);padding:24px 28px 0;flex-shrink:0">
        <div style="max-width:900px;margin:0 auto">
          ...
          <div style="display:flex;gap:0">
            ...
            <button id="ptab-reports" onclick="pTab('reports')" style="padding:10px 20px;font-size:13px;font-weight:700;cursor:pointer;border:none;background:transparent;font-family:Inter,sans-serif;color:rgba(255,255,255,.4);border-bottom:3px solid transparent;transition:all .2s">My Reports</button>
      ...
      <div style="flex:1;overflow-y:auto">
        ...
        <div id="pcon-reports" style="display:none;padding:20px;max-width:600px;margin:0 auto">
          <div style="background:white;border-radius:20px;border:1px solid #E3F2FD;box-shadow:0 2px 12px rgba(10,37,64,.06);overflow:hidden">
            <div style="padding:16px 20px;border-bottom:1px solid #F0F8FF">
  ...
  window.pTab = (tab) => {
    ['rank','reports','rewards'].forEach(t => {
  ...
  // History stream — panel exists in DOM from the start now
